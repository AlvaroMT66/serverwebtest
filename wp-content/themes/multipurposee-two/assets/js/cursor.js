...
var elements = document.getElementsByClassName('cursor_novo');
...
for (var i = 0; i < elements.length; i++) {
    ...
    newDiv.style.marginBlockStart = '0px'
    newDiv.innerHTML = `
    ...
    <div class="menu_desk" >
                    <div class="icones">
                     <a href="https://realtimethemes.com/theme/multipurpose/" style="text-decoration: none;" target="_blank">
                        <p class="vertical-text"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-instagram" viewBox="0 0 16 16">
